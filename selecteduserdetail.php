    ...
    else if($amount > $sql1['balance']) 
    {
       ...
       alert("Bad Luck! Insufficient Balance"); 
         ...
         alert('Oops! Zero value cannot be transferred');
                ...
                $sender = $sql1['name'];
                $receiver = $sql2['name'];
                $sql = ("INSERT INTO transaction(`sno`,`sender`, `receiver`, `balance`) VALUES ('','$sender','$receiver','$amount')") or die(mysql_error());
                $query=mysqli_query($conn,$sql);
...
?>
	...
	<div class="container">
        ...
        <br>
            ...
            <button class="btn mt-3" name="submit" type="submit" id="myBtn">Transfer</button></a>
            </div>
        </form>
    </div>
